...
JMP MarioFireBall : JMP return : JMP BodyInside : JMP HeadInside

MarioSide:
HeadInside:
BodyInside:			;>so mario wouldn't "vibrate" should there be a boost next to it.
...
playeroneway:
	...
	BRA solid
MarioFireBall:
	LDA $1747,x		;\solid to right-moving fireballs
	BPL solid		;/
	RTL
SpriteH:
